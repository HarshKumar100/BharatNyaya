...
const Footer = () => {
  ...
  <div className="container mx-auto px-6">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* Logo and About */}
      <div>
        <h2 className="text-2xl font-bold text-[#6A38C2]">BharatNyay</h2>
      ...
      {/* Quick Filters */}
      <div>
        <h3 className="text-lg font-semibold text-gray-800">Find Lawyers By Practice Area</h3>
        <ul className="mt-3 text-gray-600 space-y-2">
          <li><a href="#" className="hover:text-[#6A38C2]">Criminal Law</a></li>
          <li><a href="#" className="hover:text-[#6A38C2]">Civil Rights</a></li>
          <li><a href="#" className="hover:text-[#6A38C2]">Family & Divorce</a></li>
          <li><a href="#" className="hover:text-[#6A38C2]">Property Disputes</a></li>
          <li><a href="#" className="hover:text-[#6A38C2]">Corporate Law</a></li>
        </ul>
      ...
      <div>
      <h3 className="text-lg font-semibold text-gray-800 mt-6">Find Lawyers By Location</h3>
        <select className="mt-2 px-3 py-2 border border-gray-300 rounded-md w-full focus:outline-none">
    ...
    <div className="border-t border-gray-300 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
      <p className="text-gray-600 text-sm">© 2024 BharatNyay. All rights reserved.</p>
