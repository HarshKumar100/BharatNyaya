...
const Lawyer = ({lawyer}) => {
    ...
    // const lawyerId = "lsekdhjgdsnfvsdkjf";
    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
            <div className='flex items-center justify-between'>
                <p className='text-sm text-gray-500'>{daysAgoFunction(lawyer?.createdAt) === 0 ? "Today" : `${daysAgoFunction(lawyer?.createdAt)} days ago`}</p>
            ...
            <div className='flex items-center gap-2 my-2'>
                <Button className="p-6" variant="outline" size="icon">
                    <Avatar>
                        <AvatarImage src={lawyer?.court?.logo} />
                    </Avatar>
                </Button>
                <div>
